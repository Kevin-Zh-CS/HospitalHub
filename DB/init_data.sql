...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_1', 'WDNMD001', 'neo_hugh_1@996.icu.com', 'doctor', '胡洋凡一号', 2
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_1'
          AND password = 'WDNMD001'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_2', 'WDNMD002', 'neo_hugh_2@996.icu.com', 'doctor', '胡洋凡二号', 3
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_2'
          AND password = 'WDNMD002'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_3', 'WDNMD003', 'neo_hugh_3@996.icu.com', 'doctor', '胡洋凡三号', 4
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_3'
          AND password = 'WDNMD003'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_4', 'WDNMD004', 'neo_hugh_4@996.icu.com', 'doctor', '胡洋凡四号', 5
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_4'
          AND password = 'WDNMD004'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_5', 'WDNMD005', 'neo_hugh_5@996.icu.com', 'patient', '胡洋凡五号', 6
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_5'
          AND password = 'WDNMD005'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_6', 'WDNMD006', 'neo_hugh_6@996.icu.com', 'patient', '胡洋凡六号', 7
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_6'
          AND password = 'WDNMD006'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_7', 'WDNMD007', 'neo_hugh_7@996.icu.com', 'patient', '胡洋凡七号', 8
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_7'
          AND password = 'WDNMD007'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_8', 'WDNMD008', 'neo_hugh_8@996.icu.com', 'patient', '胡洋凡八号', 9
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_8'
          AND password = 'WDNMD008'
...
INSERT INTO hospital_hub_user(username, password, email, tag, true_name, age)
SELECT 'neo_hugh_9', 'WDNMD009', 'neo_hugh_9@996.icu.com', 'patient', '胡洋凡九号', 10
WHERE NOT EXISTS(
        SELECT username, password, email, tag, true_name, age
        FROM hospital_hub_user
        WHERE username = 'neo_hugh_9'
          AND password = 'WDNMD009'
